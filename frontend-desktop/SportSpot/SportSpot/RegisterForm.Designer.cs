namespace SportSpot
{
    partial class RegisterForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            pnlRegister.Controls.Add(lblTittleAlta);
            ...
            // lblTittleAlta
            // 
            lblTittleAlta.AutoSize = true;
            lblTittleAlta.Font = new Font("Segoe UI", 18F, FontStyle.Bold);
            lblTittleAlta.ForeColor = Color.FromArgb(0, 119, 255);
            lblTittleAlta.Location = new Point(313, 135);
            lblTittleAlta.Name = "lblTittleAlta";
            lblTittleAlta.Size = new Size(201, 48);
            lblTittleAlta.TabIndex = 9;
            lblTittleAlta.Text = "Alta usuari";
            lblTittleAlta.Click += lblTittleLogin_Click;
            // 
            // pictureBox1
            // 
