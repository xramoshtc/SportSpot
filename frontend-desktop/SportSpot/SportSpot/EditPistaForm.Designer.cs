namespace SportSpot
{
    partial class EditPistaForm : Form
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(EditPistaForm));
            pnlRegister = new Panel();
            CboxType = new ComboBox();
            lblEuro = new Label();
            NumPrice = new NumericUpDown();
            lblError = new Label();
            btnEditPista = new Button();
            ...
            pnlRegister.Controls.Add(btnEditPista);
            ...
            pnlRegister.Controls.Add(lblEditPista);
            ...
            // btnEditPista
            // 
            btnEditPista.BackColor = Color.FromArgb(255, 106, 0);
            btnEditPista.FlatAppearance.BorderColor = Color.FromArgb(224, 224, 224);
            btnEditPista.FlatAppearance.BorderSize = 0;
            btnEditPista.FlatStyle = FlatStyle.Flat;
            btnEditPista.Font = new Font("Segoe UI Semibold", 9F);
            btnEditPista.ForeColor = Color.White;
            btnEditPista.Location = new Point(306, 456);
            btnEditPista.Name = "btnEditPista";
            btnEditPista.Size = new Size(182, 40);
            btnEditPista.TabIndex = 5;
            btnEditPista.Text = "Desar Canvis";
            btnEditPista.UseVisualStyleBackColor = false;
            btnEditPista.Click += btnEditPista_Click;
            // 
            // lblErrorType
            // 
            ...
            // lblEditPista
            // 
            lblEditPista.AutoSize = true;
            lblEditPista.Font = new Font("Segoe UI", 18F, FontStyle.Bold);
            lblEditPista.ForeColor = Color.FromArgb(0, 119, 255);
            lblEditPista.Location = new Point(313, 135);
            lblEditPista.Name = "lblEditPista";
            lblEditPista.Size = new Size(273, 48);
            lblEditPista.TabIndex = 9;
            lblEditPista.Text = "Modificar Pista";
            // 
            // pictureBox1
            // 
